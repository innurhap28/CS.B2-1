...
class Repository:
    ...
    def get_categories(self) -> list[str]:
        return self.file_manager.read_jsonl(self.file_manager.categories_file, default=[])

    def add_category(self, category: str) -> bool:
        categories = self.file_manager.read_jsonl(self.file_manager.categories_file, default=[])
        if category in categories:
            return False
        categories.append(category)
        self.file_manager.write_jsonl(self.file_manager.categories_file, categories)
        return True
    ...
    def load_budgets(self) -> dict:
        return self.file_manager.read_jsonl(self.file_manager.budgets_file, default={})
